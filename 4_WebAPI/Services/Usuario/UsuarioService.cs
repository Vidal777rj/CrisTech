    ...
    public class UsuarioService : IUsuarioInterface
    {
        ...
        public async Task<ResponseModel<UsuarioModel>> RegistrarUsuario(UsuarioCriacaoDTO usuarioCriacaoDTO)
        {
            ...
            try
            {
                ...
                {
                    response.Mensagem = "Email ou Usu�rio j� cadastrado!";
        ...
        public async Task<ResponseModel<UsuarioModel>> ListarUsuarioPorId(int id)
        {
            ...
            try
            {
                ...
                if(usuario == null)
                {
                    response.Mensagem = "Usu�rio n�o localizado";
                    return response;
                }

                response.Dados = usuario;
                response.Mensagem = $"Usu�rio encontrado";
                response.Status = true;
                return response;
            }catch(Exception ex)
            {
        ...
        public async Task<ResponseModel<UsuarioModel>> EditarUsuario(UsuarioEdicaoDTO usuarioEdicaoDTO)
        {
            ...
            try
            {
                ...
                {
                    response.Mensagem = "Usu�rio n�o encontrado";
                    return response;
                }
                ...
                await _context.SaveChangesAsync();
                response.Mensagem = "Usu�rio atualizado com sucesso!";
        ...
        public async Task<ResponseModel<UsuarioModel>> RemoverUsuario(int id)
        {
            ...
            try
            {
                ...
                response.Dados = usuario;
                response.Mensagem = "Usu�rio deletado com sucesso!";
        ...
        public async Task<ResponseModel<UsuarioModel>> Login(UsuarioLoginDTO usuarioLoginDTO)
        {
            ...
            try
            {
                ...
                {
                    response.Mensagem = "Credenciais inv�lidas!";
                    response.Status = false;
                    return response;
                }
                ...
                response.Dados = usuario;
                response.Mensagem = "Usu�rio logado com sucesso";
                return response;
